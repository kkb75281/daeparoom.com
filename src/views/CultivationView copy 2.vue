...
.wrap
            ...
            tbody
                template(v-for="c in contents")
                    tr.tit(@click="(e) => {showCont(e)}")
                        ...
                        td {{ c.type }}
                        td {{ c.date }}
                    tr.con(v-for="(x,i) in imgtxts")
                        td(colspan="4" style='overflow: hidden;')
                            .slider__wrap
                                .slider__img
                                    .slider__inner
                                        .slider.image-column(v-if="x = `upload${i}_img`") dddd
                                            //- img(:src="`https://d1h765tqb4s5ov.cloudfront.net/publ/ap22Z0oDV9YN1w3rodru/ad5cb248-44f8-4f82-8f4d-655167007594/21351bcf-09cb-4a52-8d73-b2b10a3b1fce/records/00/ZJOB3A6h15hJ0qaL/${md5}`")
                                        .slider.text-column(v-if="x = `upload${i}_txt`") dddd
                                .slider__btn
                                    .icon.prev
                                        svg(version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 24 24" enable-background="new 0 0 24 24" xml:space="preserve")
                                            g
                        ...
                        .icon.close(@click="(e) => {closeCont(e)}")
                            svg(version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 24 24" enable-background="new 0 0 24 24" xml:space="preserve")
                                g
                                    g
                                        g
    ...
    .footer(@click="invalidUpload = !invalidUpload")
        .icon
            svg(version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 24 24" enable-background="new 0 0 24 24" xml:space="preserve")
                g
                    g
            ...
            .uploadPost 
                ...
                .uploadVisible
                    form#uploadData.uploadData(@submit='submitForm')
                        //- input#orderInp(hidden name='order')
                        .uploadInfo
                            .uploadInput
                                .input
                                    label Host
                            ...
                            .addBtn 
                                ...
                                .addTxt(@click='(e) => {checkWidth(e)}')
                                    svg.icon(version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 24 24" style="enable-background:new 0 0 24 24;" xml:space="preserve")
                                        path(d="M4.7,20.7c-0.4,0-0.7-0.1-1-0.4s-0.4-0.6-0.4-1V4.7c0-0.4,0.1-0.7,0.4-1s0.6-0.4,1-0.4h9.7l6.3,6.3v9.7c0,0.4-0.1,0.7-0.4,1s-0.6,0.4-1,0.4H4.7z M7.1,16.6h9.7v-1.5H7.1V16.6z M7.1,12.7h9.7v-1.5H7.1V12.7z M7.1,8.9h6.7V7.4H7.1V8.9z")
                                    p Add Text   
                        .mUploadSave(:class='{active: uploadSaveBtn}')
                            input.save(type='submit' value='Save')  
...
skapi.getRecords({
    ...
    for(let i=0; i<result.list.length; i++) {
        ...
        let filteredObj = filter.reduce((acc, key) => {
            if (resultData[key]) {
        ...
        imgtxts.value.push(filteredObj);
...
function closeCont(e) {
    let parentDivCont = e.target.parentNode.parentNode;
    parentDivCont.classList.toggle('active');
}
